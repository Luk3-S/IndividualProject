    ...
    while True:
        ...
        if save == True:
            if episode %100 ==0 : # 500 episode > 0 and episode % 100 ==0 
                ...
                try:
                    torch.save(A3C_shared_model.state_dict(),"{}\\500A3C_super_mario_bros_{}_{}_enc".format(desktop_path+"\\{}".format("right_a_b"),1,1))
                except:
                    print("didnt work")
        ...
        if (len(values)>0):## check if we've actually pressed said button, and if so, then apply rewards etc.
           ...
           # print("total_loss: {}".format(total_loss))
            ...
            f = open(desktop_path+"\\{}\\ep_log.txt".format("right_a_b"),"a")
