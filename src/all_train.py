    ...
    while True:
        ...
        if save == True:
            if episode %100 ==0 : 
                ...
                # save model weights for current behaviour
                torch.save(a3c_shared.state_dict(),"{}\\{}\\{}_{}_A3C_enc2".format(path,button_as_string,test_name,button_as_string)) 
        ...
        if episode == no_episodes+1:
            ...
            print("Training completed, ran for {} seconds".format(end_time-start_time))
