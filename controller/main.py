...
from controller.lstm import Actor_Critic
...
def run_lstm (prev_button_pos):
    ...
    print('Attempting to load A3C parameters : right,a,b ...')
    #print("path: {}\\{}\\{}_{}_A3C_SMB_enc".format(path,button_path,test_name,button_path))
    print("{}\\{}\\{}{}_A3C_SMB_enc2".format(path,"controller",test_name,""))
    try:
        #pretrained_dict = torch.load("{}\\500A3C_super_mario_bros_{}_{}_enc".format(desktop_path+"\\{}".format("right_a_b"),1,1))#b
        pretrained_dict = torch.load("{}\\{}\\{}{}_A3C_SMB_enc2".format(path,"controller",test_name,"")) #button_path
    ...
    train(optimiser_a3c,A3C_shared_model,CAE_shared_model,optimiser_cae)
    
    # threads = []

    # for _ in range(0,4):
    #     process = mp.Process(target=train, args = (optimiser_a3c,A3C_shared_model,CAE_shared_model,optimiser_cae))
    #     process.start()
